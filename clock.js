...
function time_is_widget(){var ca=0,tD=0,tout=0,updint=1000,tl="",u="undefined"
    ...
    this.xSync=function(q){document.scriptObj=document.createElement("script");
        var prtc=location.protocol;if(prtc!=='http:'&&prtc!=='https:')prtc='http:'
        document.scriptObj.setAttribute("src",prtc+"//widget.time.is/?"+encodeURIComponent(q.join(".."))+"&t="+new Date().getTime())
