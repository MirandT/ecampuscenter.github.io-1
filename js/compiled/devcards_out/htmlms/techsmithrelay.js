...
return cljs.core.filter.call(null,(function (p1__39863_SHARP_){
return (cljs.core.mod.call(null,x,p1__39863_SHARP_) === (0));
...
var map__39866 = bmi_data;
var map__39866__$1 = ((((!((map__39866 == null)))?((((map__39866.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39866.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39866):map__39866);
var data = map__39866__$1;
var height = cljs.core.get.call(null,map__39866__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var width = cljs.core.get.call(null,map__39866__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var bmi = cljs.core.get.call(null,map__39866__$1,new cljs.core.Keyword(null,"bmi","bmi",1421979636));
var yurl = cljs.core.get.call(null,map__39866__$1,new cljs.core.Keyword(null,"yurl","yurl",182188908));
var length = cljs.core.get.call(null,map__39866__$1,new cljs.core.Keyword(null,"length","length",588987862));
var title = cljs.core.get.call(null,map__39866__$1,new cljs.core.Keyword(null,"title","title",636505583));
var h = (height / (100));
if((bmi == null)){
...
cljs.core.swap_BANG_.call(null,htmlms.techsmithrelay.initial_length,cljs.core.assoc,new cljs.core.Keyword(null,"initlength","initlength",768389849),updlength);
...
var map__39891 = htmlms.techsmithrelay.calc_bmi.call(null,cljs.core.deref.call(null,bmi_data));
var map__39891__$1 = ((((!((map__39891 == null)))?((((map__39891.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39891.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39891):map__39891);
var width = cljs.core.get.call(null,map__39891__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__39891__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var bmi = cljs.core.get.call(null,map__39891__$1,new cljs.core.Keyword(null,"bmi","bmi",1421979636));
var yurl = cljs.core.get.call(null,map__39891__$1,new cljs.core.Keyword(null,"yurl","yurl",182188908));
var length = cljs.core.get.call(null,map__39891__$1,new cljs.core.Keyword(null,"length","length",588987862));
var title = cljs.core.get.call(null,map__39891__$1,new cljs.core.Keyword(null,"title","title",636505583));
var vec__39892 = ((((bmi > .562)) && ((bmi < .563)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["green",[cljs.core.str("approx ratio: 16:9. exact ratio: "),cljs.core.str(htmlms.techsmithrelay.width_ratio.call(null,width,height)),cljs.core.str(" by "),cljs.core.str(htmlms.techsmithrelay.height_ratio.call(null,width,height)),cljs.core.str(".")].join('')], null):((((bmi > .74)) && ((bmi < .76)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["inherit",[cljs.core.str("approx ratio: 4:3. exact ratio: "),cljs.core.str(htmlms.techsmithrelay.width_ratio.call(null,width,height)),cljs.core.str(" by "),cljs.core.str(htmlms.techsmithrelay.height_ratio.call(null,width,height)),cljs.core.str(".")].join('')], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["red",[cljs.core.str("non-standard ratio "),cljs.core.str(htmlms.techsmithrelay.width_ratio.call(null,width,height)),cljs.core.str(" by "),cljs.core.str(htmlms.techsmithrelay.height_ratio.call(null,width,height)),cljs.core.str(".")].join('')], null)
));
var color = cljs.core.nth.call(null,vec__39892,(0),null);
var diagnose = cljs.core.nth.call(null,vec__39892,(1),null);
return React.createElement("div",null,React.createElement("h3",null,"Parameters"),React.createElement("div",null,(function (){var attrs39898 = [cljs.core.str("url: "),cljs.core.str(yurl)].join('');
return cljs.core.apply.call(null,React.createElement,"span",((cljs.core.map_QMARK_.call(null,attrs39898))?sablono.interpreter.attributes.call(null,attrs39898):null),((cljs.core.map_QMARK_.call(null,attrs39898))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs39898)], null)));
})(),sablono.interpreter.interpret.call(null,htmlms.techsmithrelay.slider.call(null,bmi_data,new cljs.core.Keyword(null,"yurl","yurl",182188908),yurl,(0),(100)))),React.createElement("div",null,(function (){var attrs39899 = [cljs.core.str("width: "),cljs.core.str((width | (0))),cljs.core.str("px")].join('');
return cljs.core.apply.call(null,React.createElement,"span",((cljs.core.map_QMARK_.call(null,attrs39899))?sablono.interpreter.attributes.call(null,attrs39899):null),((cljs.core.map_QMARK_.call(null,attrs39899))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs39899)], null)));
})(),sablono.interpreter.interpret.call(null,htmlms.techsmithrelay.slider.call(null,bmi_data,new cljs.core.Keyword(null,"width","width",-384071477),width,(30),(150)))),React.createElement("div",null,(function (){var attrs39900 = [cljs.core.str("height: "),cljs.core.str((height | (0))),cljs.core.str("px")].join('');
return cljs.core.apply.call(null,React.createElement,"span",((cljs.core.map_QMARK_.call(null,attrs39900))?sablono.interpreter.attributes.call(null,attrs39900):null),((cljs.core.map_QMARK_.call(null,attrs39900))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs39900)], null)));
})(),sablono.interpreter.interpret.call(null,htmlms.techsmithrelay.slider.call(null,bmi_data,new cljs.core.Keyword(null,"height","height",1025178622),height,(100),(220)))),React.createElement("div",null,(function (){var attrs39901 = [cljs.core.str("length: "),cljs.core.str(length)].join('');
return cljs.core.apply.call(null,React.createElement,"span",((cljs.core.map_QMARK_.call(null,attrs39901))?sablono.interpreter.attributes.call(null,attrs39901):null),((cljs.core.map_QMARK_.call(null,attrs39901))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs39901)], null)));
})(),sablono.interpreter.interpret.call(null,htmlms.techsmithrelay.slider.call(null,bmi_data,new cljs.core.Keyword(null,"length","length",588987862),length,(0),(100)))),React.createElement("div",null,(function (){var attrs39902 = [cljs.core.str("Title: "),cljs.core.str(title)].join('');
return cljs.core.apply.call(null,React.createElement,"span",((cljs.core.map_QMARK_.call(null,attrs39902))?sablono.interpreter.attributes.call(null,attrs39902):null),((cljs.core.map_QMARK_.call(null,attrs39902))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs39902)], null)));
})(),sablono.interpreter.interpret.call(null,htmlms.techsmithrelay.slider.call(null,bmi_data,new cljs.core.Keyword(null,"title","title",636505583),title,(0),(100)))),React.createElement("div",null,(function (){var attrs39903 = [cljs.core.str("ratio: "),cljs.core.str(cljs.pprint.cl_format.call(null,null,"~,3f",bmi)),cljs.core.str(" ")].join('');
return cljs.core.apply.call(null,React.createElement,"span",((cljs.core.map_QMARK_.call(null,attrs39903))?sablono.interpreter.attributes.call(null,attrs39903):null),((cljs.core.map_QMARK_.call(null,attrs39903))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs39903)], null)));
})(),React.createElement("span",({"style": ({"color": color})}),sablono.interpreter.interpret.call(null,diagnose)),sablono.interpreter.interpret.call(null,htmlms.techsmithrelay.slider.call(null,bmi_data,new cljs.core.Keyword(null,"bmi","bmi",1421979636),bmi,(10),(50)))),React.createElement("div",null,(function (){var attrs39904 = [cljs.core.str("html:")].join('');
return cljs.core.apply.call(null,React.createElement,"span",((cljs.core.map_QMARK_.call(null,attrs39904))?sablono.interpreter.attributes.call(null,attrs39904):null),((cljs.core.map_QMARK_.call(null,attrs39904))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs39904)], null)));
})(),sablono.interpreter.interpret.call(null,htmlms.techsmithrelay.htmlout.call(null,bmi_data,new cljs.core.Keyword(null,"yurl","yurl",182188908),yurl,width,height,(10),(50),length,title))),React.createElement("div",null,(function (){var attrs39905 = [cljs.core.str("preview:")].join('');
return cljs.core.apply.call(null,React.createElement,"span",((cljs.core.map_QMARK_.call(null,attrs39905))?sablono.interpreter.attributes.call(null,attrs39905):null),((cljs.core.map_QMARK_.call(null,attrs39905))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs39905)], null)));
...
//# sourceMappingURL=techsmithrelay.js.map?rel=1475273009055