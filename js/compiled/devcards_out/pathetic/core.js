...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__20228_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__20228_SHARP_),cljs.core.second.call(null,p1__20228_SHARP_));
}),cljs.core.map.call(null,(function (p1__20229_SHARP_,p2__20230_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__20229_SHARP_,p2__20230_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__20232 = cljs.core.first.call(null,path_pieces);
switch (G__20232) {
case "":
...
var G__20235 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__20235) {
case "root":
...
var G__20238 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__20238)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__20238)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__20238)){
return path_pieces;
} else {
...
while(true){
var vec__20243 = remaining_path;
var curr = cljs.core.nth.call(null,vec__20243,(0),null);
var remainder = cljs.core.nthnext.call(null,vec__20243,(1));
var pred__20244 = cljs.core._EQ_;
var expr__20245 = curr;
if(cljs.core.truth_(pred__20244.call(null,null,expr__20245))){
return result;
} else {
if(cljs.core.truth_(pred__20244.call(null,"",expr__20245))){
var G__20247 = result;
var G__20248 = remainder;
result = G__20247;
remaining_path = G__20248;
continue;
} else {
if(cljs.core.truth_(pred__20244.call(null,".",expr__20245))){
var G__20249 = result;
var G__20250 = remainder;
result = G__20249;
remaining_path = G__20250;
continue;
} else {
if(cljs.core.truth_(pred__20244.call(null,"..",expr__20245))){
var G__20251 = pathetic.core.up_dir.call(null,result);
var G__20252 = remainder;
result = G__20251;
remaining_path = G__20252;
continue;
} else {
var G__20253 = cljs.core.conj.call(null,result,curr);
var G__20254 = remainder;
result = G__20253;
remaining_path = G__20254;
continue;
}
}
}
...
var pred__20258 = cljs.core._EQ_;
var expr__20259 = curr;
if(cljs.core.truth_(pred__20258.call(null,null,expr__20259))){
return suffix;
} else {
if(cljs.core.truth_(pred__20258.call(null,"",expr__20259))){
var G__20261 = suffix;
var G__20262 = cljs.core.rest.call(null,remainder);
suffix = G__20261;
remainder = G__20262;
continue;
} else {
if(cljs.core.truth_(pred__20258.call(null,".",expr__20259))){
var G__20263 = suffix;
var G__20264 = cljs.core.rest.call(null,remainder);
suffix = G__20263;
remainder = G__20264;
continue;
} else {
if(cljs.core.truth_(pred__20258.call(null,"..",expr__20259))){
var G__20265 = cljs.core.conj.call(null,suffix,"..");
var G__20266 = cljs.core.rest.call(null,remainder);
suffix = G__20265;
remainder = G__20266;
continue;
} else {
var G__20267 = cljs.core.conj.call(null,suffix,curr);
var G__20268 = cljs.core.rest.call(null,remainder);
suffix = G__20267;
remainder = G__20268;
continue;
}
...
var vec__20270 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__20270,(0),null);
var path = cljs.core.nth.call(null,vec__20270,(1),null);
var post_path = cljs.core.nth.call(null,vec__20270,(2),null);
...
var vec__20272 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__20272,(0),null);
var path = cljs.core.nth.call(null,vec__20272,(1),null);
var post_path = cljs.core.nth.call(null,vec__20272,(2),null);
...
//# sourceMappingURL=core.js.map?rel=1453927178298