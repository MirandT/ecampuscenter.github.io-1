...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__28361_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__28361_SHARP_),cljs.core.second.call(null,p1__28361_SHARP_));
}),cljs.core.map.call(null,(function (p1__28362_SHARP_,p2__28363_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__28362_SHARP_,p2__28363_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__28368 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__28368) {
case "root":
...
var G__28371 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__28371)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__28371)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__28371)){
return path_pieces;
} else {
...
var curr = first__28380;
var remainder = seq__28379__$1;
var pred__28381 = cljs.core._EQ_;
var expr__28382 = curr;
if(cljs.core.truth_(pred__28381.call(null,null,expr__28382))){
return result;
} else {
if(cljs.core.truth_(pred__28381.call(null,"",expr__28382))){
var G__28384 = result;
...
if(cljs.core.truth_(pred__28381.call(null,"..",expr__28382))){
var G__28388 = pathetic.core.up_dir.call(null,result);
var G__28389 = remainder;
result = G__28388;
remaining_path = G__28389;
continue;
} else {
var G__28390 = cljs.core.conj.call(null,result,curr);
var G__28391 = remainder;
result = G__28390;
remaining_path = G__28391;
continue;
}
}
}
...
var expr__28396 = curr;
if(cljs.core.truth_(pred__28395.call(null,null,expr__28396))){
return suffix;
} else {
if(cljs.core.truth_(pred__28395.call(null,"",expr__28396))){
var G__28398 = suffix;
...
if(cljs.core.truth_(pred__28395.call(null,"..",expr__28396))){
var G__28402 = cljs.core.conj.call(null,suffix,"..");
var G__28403 = cljs.core.rest.call(null,remainder);
suffix = G__28402;
remainder = G__28403;
continue;
} else {
var G__28404 = cljs.core.conj.call(null,suffix,curr);
var G__28405 = cljs.core.rest.call(null,remainder);
suffix = G__28404;
remainder = G__28405;
continue;
}
...
var vec__28409 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__28409,(0),null);
var path = cljs.core.nth.call(null,vec__28409,(1),null);
var post_path = cljs.core.nth.call(null,vec__28409,(2),null);
...
var vec__28415 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__28415,(0),null);
var path = cljs.core.nth.call(null,vec__28415,(1),null);
var post_path = cljs.core.nth.call(null,vec__28415,(2),null);
...
//# sourceMappingURL=core.js.map?rel=1474300066596