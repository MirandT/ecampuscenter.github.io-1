...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19322__auto__,writer__19323__auto__,opt__19324__auto__){
return cljs.core._write.call(null,writer__19323__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28016 = o;
(G__28016[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__18704__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18704__auto__){
var and__18704__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__28025 = jsprops;
(G__28025["defaultValue"] = value);

(G__28025["onChange"] = ((function (G__28025,v,value,on_change){
return (function (p1__28022_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28022_SHARP_);
});})(G__28025,v,value,on_change))
);

(G__28025["ref"] = ((function (G__28025,v,value,on_change){
return (function (p1__28023_SHARP_){
return (this$["cljsInputElement"] = p1__28023_SHARP_);
});})(G__28025,v,value,on_change))
);
...
var vec__28032 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28032,(0),null);
var id = cljs.core.nth.call(null,vec__28032,(1),null);
var class$ = cljs.core.nth.call(null,vec__28032,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___28037 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___28037 == null)){
} else {
var key_28038 = temp__4661__auto___28037;
(jsprops["key"] = key_28038);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__28040 = (new reagent.impl.template.NativeWrapper());
(G__28040["name"] = c);
...
var len__19791__auto___28046 = arguments.length;
var i__19792__auto___28047 = (0);
while(true){
if((i__19792__auto___28047 < len__19791__auto___28046)){
args__19798__auto__.push((arguments[i__19792__auto___28047]));

var G__28048 = (i__19792__auto___28047 + (1));
i__19792__auto___28047 = G__28048;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19799__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28044){
var G__28045 = cljs.core.first.call(null,seq28044);
var seq28044__$1 = cljs.core.next.call(null,seq28044);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28045,seq28044__$1);
});
...
break;
default:
var G__28052 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__28052;
continue;
...
var n__19631__auto___28055 = a.length;
var i_28056 = (0);
while(true){
if((i_28056 < n__19631__auto___28055)){
(a[i_28056] = reagent.impl.template.as_element.call(null,(a[i_28056])));
...
var a = cljs.core.into_array.call(null,s);
var n__19631__auto___28058 = a.length;
var i_28059 = (0);
while(true){
if((i_28059 < n__19631__auto___28058)){
var val_28060 = (a[i_28059]);
if((cljs.core.vector_QMARK_.call(null,val_28060)) && ((reagent.impl.template.key_from_vec.call(null,val_28060) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28059] = reagent.impl.template.as_element.call(null,val_28060));

var G__28061 = (i_28059 + (1));
i_28059 = G__28061;
continue;
} else {
}
...
var ctx = ({});
var vec__28065 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28065,(0),null);
var derefed = cljs.core.nth.call(null,vec__28065,(1),null);
...
var G__28069 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28069) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__28069){
...
//# sourceMappingURL=template.js.map?rel=1474300065692