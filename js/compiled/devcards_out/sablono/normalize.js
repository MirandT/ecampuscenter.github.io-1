...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__25417_SHARP_){
return ((p1__25417_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__25417_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__25419,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__25419;
}
});
...
var len__19791__auto___25422 = arguments.length;
var i__19792__auto___25423 = (0);
while(true){
if((i__19792__auto___25423 < len__19791__auto___25422)){
args__19798__auto__.push((arguments[i__19792__auto___25423]));

var G__25424 = (i__19792__auto___25423 + (1));
i__19792__auto___25423 = G__25424;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__19799__auto__);
});
...
var G__25421 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__25421,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__25421;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq25420){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25420));
});
...
var vec__25430 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__25430,(0),null);
var names = cljs.core.nth.call(null,vec__25430,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__25430,tag_name,names){
return (function (p1__25425_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__25425_SHARP_));
});})(matches,vec__25430,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__25430,tag_name,names){
return (function (p1__25426_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__25426_SHARP_));
});})(matches,vec__25430,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__25433){
var vec__25440 = p__25433;
var seq__25441 = cljs.core.seq.call(null,vec__25440);
var first__25442 = cljs.core.first.call(null,seq__25441);
var seq__25441__$1 = cljs.core.next.call(null,seq__25441);
var tag = first__25442;
var content = seq__25441__$1;
...
var vec__25443 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__25443,(0),null);
var id = cljs.core.nth.call(null,vec__25443,(1),null);
var class$ = cljs.core.nth.call(null,vec__25443,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1474300061098