...
var len__17884__auto___23089 = arguments.length;
var i__17885__auto___23090 = (0);
while(true){
if((i__17885__auto___23090 < len__17884__auto___23089)){
args__17891__auto__.push((arguments[i__17885__auto___23090]));

var G__23091 = (i__17885__auto___23090 + (1));
i__17885__auto___23090 = G__23091;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq23088){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23088));
});
/**
...
var vec__23093 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__23093,(0),null);
var words = cljs.core.nthnext.call(null,vec__23093,(1));
...
var G__23095 = clojure.set.rename_keys.call(null,m,kmap);
var G__23095__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__23095,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__23095);
return G__23095__$1;
} else {
return m;
}
...
var args__17891__auto__ = [];
var len__17884__auto___23098 = arguments.length;
var i__17885__auto___23099 = (0);
while(true){
if((i__17885__auto___23099 < len__17884__auto___23098)){
args__17891__auto__.push((arguments[i__17885__auto___23099]));

var G__23100 = (i__17885__auto___23099 + (1));
i__17885__auto___23099 = G__23100;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__23096_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__23096_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__23096_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__23096_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq23097){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23097));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__23104,(0),null);
var names = cljs.core.nth.call(null,vec__23104,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__23104,tag_name,names){
return (function (p1__23101_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__23101_SHARP_));
});})(matches,vec__23104,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__23104,tag_name,names){
return (function (p1__23102_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__23102_SHARP_));
});})(matches,vec__23104,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__23105){
var vec__23108 = p__23105;
var tag = cljs.core.nth.call(null,vec__23108,(0),null);
var content = cljs.core.nthnext.call(null,vec__23108,(1));
...
var vec__23109 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__23109,(0),null);
var id = cljs.core.nth.call(null,vec__23109,(1),null);
var class$ = cljs.core.nth.call(null,vec__23109,(2),null);
...
//# sourceMappingURL=util.js.map?rel=1452098819483