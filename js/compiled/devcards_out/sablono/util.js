...
var x__17507__auto__ = (((x == null))?null:x);
var m__17508__auto__ = (sablono.util.to_str[goog.typeOf(x__17507__auto__)]);
if(!((m__17508__auto__ == null))){
return m__17508__auto__.call(null,x);
} else {
var m__17508__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__17508__auto____$1 == null))){
return m__17508__auto____$1.call(null,x);
} else {
...
var x__17507__auto__ = (((x == null))?null:x);
var m__17508__auto__ = (sablono.util.to_uri[goog.typeOf(x__17507__auto__)]);
if(!((m__17508__auto__ == null))){
return m__17508__auto__.call(null,x);
} else {
var m__17508__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__17508__auto____$1 == null))){
return m__17508__auto____$1.call(null,x);
} else {
...
var len__17910__auto___23252 = arguments.length;
var i__17911__auto___23253 = (0);
while(true){
if((i__17911__auto___23253 < len__17910__auto___23252)){
args__17917__auto__.push((arguments[i__17911__auto___23253]));

var G__23254 = (i__17911__auto___23253 + (1));
i__17911__auto___23253 = G__23254;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__17918__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq23251){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23251));
});
/**
...
var vec__23256 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__23256,(0),null);
var words = cljs.core.nthnext.call(null,vec__23256,(1));
...
var G__23258 = clojure.set.rename_keys.call(null,m,kmap);
var G__23258__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__23258,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__23258);
return G__23258__$1;
} else {
return m;
}
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__16852__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1453415053004