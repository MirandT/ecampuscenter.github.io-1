...
var args23532 = [];
var len__10647__auto___23536 = arguments.length;
var i__10648__auto___23537 = (0);
while(true){
if((i__10648__auto___23537 < len__10647__auto___23536)){
args23532.push((arguments[i__10648__auto___23537]));

var G__23538 = (i__10648__auto___23537 + (1));
i__10648__auto___23537 = G__23538;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args23532.length)].join('')));
...
var G__23535 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__23535,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__23535;
}
});
...
var len__10647__auto___23543 = arguments.length;
var i__10648__auto___23544 = (0);
while(true){
if((i__10648__auto___23544 < len__10647__auto___23543)){
args__10654__auto__.push((arguments[i__10648__auto___23544]));

var G__23545 = (i__10648__auto___23544 + (1));
i__10648__auto___23544 = G__23545;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq23540){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__23541,G__23542,seq23540__$2);
});
...
var file = cljs.core.get.call(null,map__23549__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__23549__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__23549__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__23549,map__23549__$1,file,line,column){
return (function (p1__23546_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__23546_SHARP_));
});})(map__23549,map__23549__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__10457__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__10457__auto__,prefer_table__10458__auto__,method_cache__10459__auto__,cached_hierarchy__10460__auto__,hierarchy__10461__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__9426__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__9426__auto__)){
return or__9426__auto__;
} else {
...
var temp__6738__auto___23551 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6738__auto___23551)){
var message_23552 = temp__6738__auto___23551;
cljs.core.println.call(null,message_23552);
} else {
}
...
var temp__6738__auto___23553 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6738__auto___23553)){
var message_23554 = temp__6738__auto___23553;
cljs.core.println.call(null,message_23554);
} else {
}
...
var G__23564 = exception.stack;
var G__23564__$1 = (((G__23564 == null))?null:clojure.string.split_lines.call(null,G__23564));
var G__23564__$2 = (((G__23564__$1 == null))?null:cljs.core.get.call(null,G__23564__$1,depth));
if((G__23564__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__23564__$2);
}
} else {
...
var vec__23565 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__23565,(0),null);
var column = cljs.core.nth.call(null,vec__23565,(1),null);
var vec__23568 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__23568,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__23568,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__23568,(2),null);
...
var m__$1 = (function (){var G__23572 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__23578 = (function (){var G__23577 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__23577);
} else {
return G__23577;
}
})();
...
return cljs.core.vary_meta.call(null,G__23580,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__23589 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__23589,(0),null);
var types = vec__23589;
...
var vars__$1 = cljs.core.nth.call(null,vec__23602,(1),null);
return ((function (vec__23602,ns,vars__$1){
return (function (){
...
var G__23605 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__23605__$1 = (((G__23605 instanceof cljs.core.Keyword))?G__23605.fqn:null);
switch (G__23605__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__23605,G__23605__$1,env,once_fixtures,each_fixtures,vec__23602,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__23605,G__23605__$1,env,once_fixtures,each_fixtures,vec__23602,ns,vars__$1){
return (function (){
var seq__23606 = cljs.core.seq.call(null,vars__$1);
var chunk__23607 = null;
var count__23608 = (0);
var i__23609 = (0);
while(true){
if((i__23609 < count__23608)){
var v = cljs.core._nth.call(null,chunk__23607,i__23609);
var temp__6738__auto___23611 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6738__auto___23611)){
var t_23612 = temp__6738__auto___23611;
each_fixture_fn.call(null,((function (seq__23606,chunk__23607,count__23608,i__23609,t_23612,temp__6738__auto___23611,v,each_fixture_fn,G__23605,G__23605__$1,env,once_fixtures,each_fixtures,vec__23602,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23612)));
});})(seq__23606,chunk__23607,count__23608,i__23609,t_23612,temp__6738__auto___23611,v,each_fixture_fn,G__23605,G__23605__$1,env,once_fixtures,each_fixtures,vec__23602,ns,vars__$1))
);
} else {
}

var G__23613 = seq__23606;
var G__23614 = chunk__23607;
var G__23615 = count__23608;
var G__23616 = (i__23609 + (1));
seq__23606 = G__23613;
chunk__23607 = G__23614;
count__23608 = G__23615;
i__23609 = G__23616;
continue;
} else {
var temp__6738__auto__ = cljs.core.seq.call(null,seq__23606);
if(temp__6738__auto__){
var seq__23606__$1 = temp__6738__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__23606__$1)){
var c__10337__auto__ = cljs.core.chunk_first.call(null,seq__23606__$1);
var G__23617 = cljs.core.chunk_rest.call(null,seq__23606__$1);
var G__23618 = c__10337__auto__;
var G__23619 = cljs.core.count.call(null,c__10337__auto__);
var G__23620 = (0);
seq__23606 = G__23617;
chunk__23607 = G__23618;
count__23608 = G__23619;
i__23609 = G__23620;
continue;
} else {
var v = cljs.core.first.call(null,seq__23606__$1);
var temp__6738__auto___23621__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6738__auto___23621__$1)){
var t_23622 = temp__6738__auto___23621__$1;
each_fixture_fn.call(null,((function (seq__23606,chunk__23607,count__23608,i__23609,t_23622,temp__6738__auto___23621__$1,v,seq__23606__$1,temp__6738__auto__,each_fixture_fn,G__23605,G__23605__$1,env,once_fixtures,each_fixtures,vec__23602,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23622)));
});})(seq__23606,chunk__23607,count__23608,i__23609,t_23622,temp__6738__auto___23621__$1,v,seq__23606__$1,temp__6738__auto__,each_fixture_fn,G__23605,G__23605__$1,env,once_fixtures,each_fixtures,vec__23602,ns,vars__$1))
);
} else {
}

var G__23623 = cljs.core.next.call(null,seq__23606__$1);
var G__23624 = null;
var G__23625 = (0);
var G__23626 = (0);
seq__23606 = G__23623;
chunk__23607 = G__23624;
count__23608 = G__23625;
i__23609 = G__23626;
continue;
}
} else {
...
});})(each_fixture_fn,G__23605,G__23605__$1,env,once_fixtures,each_fixtures,vec__23602,ns,vars__$1))
);
});})(each_fixture_fn,G__23605,G__23605__$1,env,once_fixtures,each_fixtures,vec__23602,ns,vars__$1))
], null);
