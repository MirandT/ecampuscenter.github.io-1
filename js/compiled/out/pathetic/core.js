...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__6005_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__6005_SHARP_),cljs.core.second.call(null,p1__6005_SHARP_));
}),cljs.core.map.call(null,(function (p1__6006_SHARP_,p2__6007_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__6006_SHARP_,p2__6007_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__6009 = cljs.core.first.call(null,path_pieces);
switch (G__6009) {
case "":
...
var G__6012 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__6012) {
case "root":
...
var G__6015 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__6015)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__6015)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__6015)){
return path_pieces;
} else {
...
while(true){
var vec__6020 = remaining_path;
var curr = cljs.core.nth.call(null,vec__6020,(0),null);
var remainder = cljs.core.nthnext.call(null,vec__6020,(1));
var pred__6021 = cljs.core._EQ_;
var expr__6022 = curr;
if(cljs.core.truth_(pred__6021.call(null,null,expr__6022))){
return result;
} else {
if(cljs.core.truth_(pred__6021.call(null,"",expr__6022))){
var G__6024 = result;
var G__6025 = remainder;
result = G__6024;
remaining_path = G__6025;
continue;
} else {
if(cljs.core.truth_(pred__6021.call(null,".",expr__6022))){
var G__6026 = result;
var G__6027 = remainder;
result = G__6026;
remaining_path = G__6027;
continue;
} else {
if(cljs.core.truth_(pred__6021.call(null,"..",expr__6022))){
var G__6028 = pathetic.core.up_dir.call(null,result);
var G__6029 = remainder;
result = G__6028;
remaining_path = G__6029;
continue;
} else {
var G__6030 = cljs.core.conj.call(null,result,curr);
var G__6031 = remainder;
result = G__6030;
remaining_path = G__6031;
continue;
}
}
}
...
var pred__6035 = cljs.core._EQ_;
var expr__6036 = curr;
if(cljs.core.truth_(pred__6035.call(null,null,expr__6036))){
return suffix;
} else {
if(cljs.core.truth_(pred__6035.call(null,"",expr__6036))){
var G__6038 = suffix;
var G__6039 = cljs.core.rest.call(null,remainder);
suffix = G__6038;
remainder = G__6039;
continue;
} else {
if(cljs.core.truth_(pred__6035.call(null,".",expr__6036))){
var G__6040 = suffix;
var G__6041 = cljs.core.rest.call(null,remainder);
suffix = G__6040;
remainder = G__6041;
continue;
} else {
if(cljs.core.truth_(pred__6035.call(null,"..",expr__6036))){
var G__6042 = cljs.core.conj.call(null,suffix,"..");
var G__6043 = cljs.core.rest.call(null,remainder);
suffix = G__6042;
remainder = G__6043;
continue;
} else {
var G__6044 = cljs.core.conj.call(null,suffix,curr);
var G__6045 = cljs.core.rest.call(null,remainder);
suffix = G__6044;
remainder = G__6045;
continue;
}
...
var vec__6047 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__6047,(0),null);
var path = cljs.core.nth.call(null,vec__6047,(1),null);
var post_path = cljs.core.nth.call(null,vec__6047,(2),null);
...
var vec__6049 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__6049,(0),null);
var path = cljs.core.nth.call(null,vec__6049,(1),null);
var post_path = cljs.core.nth.call(null,vec__6049,(2),null);
...
//# sourceMappingURL=core.js.map?rel=1455038944436